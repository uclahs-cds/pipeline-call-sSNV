params{
    workflow_output_dir = "${params.output_dir}/${params.somaticsniper_version}"
    workflow_output_log_dir = "${params.output_log_dir}/process-log/${params.somaticsniper_version}"
}

...
process call_sSNV_SomaticSniper {
    ...
    publishDir path: "${params.output_dir}/${params.somaticsniper_version}/intermediate/${task.process}",
               mode: "copy",
               pattern: "somaticsniper_*",
               enabled: params.save_intermediate_files
    publishDir path: "${params.output_log_dir}/process-log/${params.somaticsniper_version}",
               mode: "copy",
               pattern: ".command.*",
...
process call_HighConfidenceSNV_SomaticSniper {
    container docker_image_somaticsniper
    publishDir path: "${params.output_dir}/${params.somaticsniper_version}/output",

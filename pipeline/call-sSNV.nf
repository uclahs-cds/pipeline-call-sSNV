...
include { mutect2tumor } from './modules/mutect2tumor' addParams(workflow_output_dir: "${params.output_dir}/mutect2tumor-${params.gatk_version}", workflow_output_log_dir: "${params.output_log_dir}/process-log/mutect2tumor-${params.gatk_version}")

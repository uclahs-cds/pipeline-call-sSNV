...
| germline_resource_gnomad_vcf_gz | path | A copy of the gnomAD VCF only kept AF but stripped of all unnecessary INFO fields, currently only available for GRCh38 (/hot/ref/tool-specific-input/GATK/GRCh38/af-only-gnomad.hg38.vcf.gz). | Config File |

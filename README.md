...
Version: 4.2.4.0 (Released on Dec 15, 2021)
Docker image: broadinstitute/gatk:4.2.4.0
...
| tumor_only_mode | boolean | A option for mutect2 algorithm when no normal control sample in the datasets | Config File |

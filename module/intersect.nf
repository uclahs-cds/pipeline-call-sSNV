...
include { intersect_VCFs_BCFtools; plot_VennDiagram_R; concat_VCFs_BCFtools ; convert_VCF_vcf2maf; compress_MAF_blarchive } from './intersect-processes.nf'
...
workflow intersect {
    ...
    main:
        ...
        compress_MAF_blarchive(convert_VCF_vcf2maf.out.concat_maf)
        file_for_sha512 = intersect_VCFs_BCFtools.out.consensus_vcf
            ...
            .mix(compress_MAF_blarchive.out.concat_maf_bz2
                .map{ it -> ["concat-SNV-MAF", it]}
                )
